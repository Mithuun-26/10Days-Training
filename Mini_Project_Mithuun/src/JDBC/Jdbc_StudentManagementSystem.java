	...
	public static void main(String[] args) throws Exception {
		...
		do {
			...
			case 1:
				...
				int age = sc.nextInt();
				sc.nextLine();
				PreparedStatement insertStmt = con.prepareStatement("INSERT INTO student (rollNo,name,age) VALUES (?,?,?)");
			...
			case 2:
				...
				ResultSet rs = viewStmt.executeQuery("SELECT * FROM student");
				System.out.println("\n Students List:");
				while (rs.next()) {
...
//				PreparedStatement updateStmt = con.prepareStatement("UPDATE books SET name = ? WHERE rollNo = ?");
//				updateStmt.setString(2, newTitle);
//				updateStmt.setInt(1, updateId);
...
//				break;
			case 3:
			    ...
			    PreparedStatement searchStmt = con.prepareStatement("SELECT * FROM student WHERE rollNo = ?");
